defmodule Sublist do
  ...
  defp found_at_current_pos([lhead | _ltail], [shead | _stail]) when not (lhead === shead), do: false
  defp found_at_current_pos([head | ltail], [head | stail]), do: found_at_current_pos(ltail, stail)
